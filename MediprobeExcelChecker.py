...
if input_filename is not '':
	...
	errors_found = excel_form.CheckTotalLines(['Hospital_Beds_Total', 'Hospital_Beds_Total_Range'], list_bed_totals)
	PrintResults(errors_found)

	print('\tChecking Nurse Totals...', end="", flush=True)
	errors_found = excel_form.CheckTotalLines(['Hospital_NursesTotal', 'Hospital_NursesTotal_Range'], list_nurse_totals)
	PrintResults(errors_found)
